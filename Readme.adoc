...
[source]
----
C:\IntraFind\jdk\bin\java -jar if-log4shell-updater-1.4.2-jar-with-dependencies.jar -p C:\IntraFind
----
...
[source]
----
C:\IntraFind\jdk\bin\java -jar if-log4shell-updater-1.4.2-jar-with-dependencies.jar -p C:\IntraFind -b
----
...
[source]
----
/opt/intrafind/jdk/bin/java -jar if-log4shell-updater-1.4.2-jar-with-dependencies.jar -p /opt/intrafind
----
...
[source]
----
/opt/intrafind/jdk/bin/java -jar if-log4shell-updater-1.4.2-jar-with-dependencies.jar -p /opt/intrafind -b
----
