...
If you decide to choose a different location, make sure the tool is located _outside_ of what you are going to process with that same tool.
...
Falls Sie einen anderen Ordner verwenden wollen, sorgen Sie in jedem Fall dafür, dass das Tool _nicht_ in dem Bereich liegt, den Sie mit eben diesem Tool bearbeiten wollen - dies kann zu Problemen führen.
